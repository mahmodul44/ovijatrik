    ...
    <div class="flex justify-between items-center mb-6">
        <nav class="text-sm text-gray-500 dark:text-gray-400">
            <ol class="list-reset flex">
                ...
                <li class="text-gray-700 dark:text-gray-300">Expense Category List</li>
            </ol>
        </nav>
            ...
            @forelse($categories as $index => $value)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    ...
                    <td
                        ...
                        <!-- Edit Button -->
                        <a href="{{ route('expensecategory.edit', $value->expense_cat_id) }}"
                        ...
                        <!-- Delete Button -->
                        <form action="{{ route('expensecategory.destroy', $value->expense_cat_id) }}" method="POST"
