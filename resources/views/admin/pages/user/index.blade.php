...
<div class="p-5 max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        <nav class="flex items-center space-x-2 text-sm text-gray-500 bg-gray-50 dark:bg-gray-800 px-4 py-2 rounded-lg shadow-sm">
            ...
            <span>/</span>
            <span class="text-gray-700 dark:text-gray-300 font-semibold">User List</span>
        </nav>
        <a href="{{ route('user.create') }}" class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg shadow-lg transition">
        ...
        <table id="projectTable" class="min-w-full text-sm text-left border-collapse">
           <thead class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200">
            <tr>
                ...
                <th class="px-6 py-3 border border-gray-200 dark:border-gray-600 text-center w-20%" style="text-align: center">Member ID</th>
            ...
            <tbody class="bg-white dark:bg-gray-800">
                @forelse($users as $index => $value)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                        ...
                        <td class="px-6 py-4 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 truncate" style="text-align: center">{{ $value->member_id }}</td>
                        <td class="px-6 py-4 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-400" style="text-align: center">{{ $value->phone_no }}</td>
                        <td class="px-6 py-4 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-400" style="text-align: center">{{ $value->email }}</td>
                        ...
                        class="inline-flex items-center px-3 py-1 text-xs font-medium text-blue-600 bg-blue-50 rounded hover:bg-blue-100 mr-2">
                            <!-- Smart Professional Eye Icon for Preview -->
