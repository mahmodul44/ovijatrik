...
<!-- Invoice Details Row -->
    <div class="invoice-details-row">
        <p>Invoice No: <span>{{ $invoiceInfo->fls_receipt_no }}</span></p>
        <p>Date: <span>{{ \Carbon\Carbon::parse($invoiceInfo->fls_receipt_date)->format('d M, Y') }}</span></p>
    </div>
 ...
 <!-- Bill To Section -->
    ...
    <table class="payment">
      ...
      <tr>
        ...
        <td>{{ number_format($invoiceInfo->fls_receipt_amount, 2) }} BDT</td>
      </tr>
    </table>
    <!-- Payment Method -->
