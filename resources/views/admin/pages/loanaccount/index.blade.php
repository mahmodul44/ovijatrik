    ...
    <div class="flex justify-between items-center mb-6">
        <nav class="text-sm text-gray-500 dark:text-gray-400">
            <ol class="list-reset flex">
                ...
                <li class="text-gray-700 dark:text-gray-300">Loan Account List</li>
            </ol>
        </nav>
    ...
    <table id="accountTable"
        ...
        <thead
            ...
            <tr>
                ...
                <th class="px-6 py-3 !text-center font-semibold border dark:border-gray-700">Opening</th>
                <th class="px-6 py-3 !text-center font-semibold border dark:border-gray-700">Current Balance</th>
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            @forelse($accounts as $index => $value)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    ...
                    <td class="px-6 py-4 text-right text-gray-600 dark:text-gray-300 border dark:border-gray-700">
