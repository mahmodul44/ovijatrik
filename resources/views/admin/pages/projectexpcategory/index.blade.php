    ...
    <div class="flex justify-between items-center mb-6">
        <nav class="text-sm text-gray-500 dark:text-gray-400">
            <ol class="list-reset flex">
                ...
                <li class="text-gray-700 dark:text-gray-300">Project Expense Category List</li>
            </ol>
        </nav>
        
        <a href="{{ route('project-expcat-create') }}"
            ...
            @forelse($categories as $index => $value)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    ...
                    <td
                        ...
                        <!-- Edit Button -->
                        <a href="{{ route('project-expcat-edit', $value->project_exp_cat_id) }}"
                        ...
                        <!-- Delete Button -->
                        <form action="{{ route('project-expcat-destroy', $value->project_exp_cat_id) }}" method="POST"
