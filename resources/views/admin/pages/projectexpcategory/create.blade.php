...
<div class="p-6 max-w-5xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <nav class="text-sm text-gray-500 dark:text-gray-400 mb-3 md:mb-0" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li class="text-gray-700 dark:text-gray-200 font-medium">Project Expense Category Add</li>
            </ol>
        </nav>
    ...
    <div class="bg-white dark:bg-gray-900 shadow-lg rounded-xl p-8 border border-gray-200 dark:border-gray-700">
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-6 border-b border-gray-200 dark:border-gray-700 pb-3">
            New Project Expense Category
        </h2>

        <form id="proexpenseCatInsertForm" enctype="multipart/form-data" class="space-y-6">
            @csrf
...
@push('scripts')
<script>
$("#proexpenseCatInsertForm").on('submit', function(e){
    e.preventDefault();
    let thisForm = $(this);
    ...
    $.ajax({
        type: "POST",
        url: "{{route('project-expcat-store')}}",
