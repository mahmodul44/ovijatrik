...
<div class="p-4 max-w-7xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-900 shadow-md rounded-xl p-6 space-y-4 border border-gray-200 dark:border-gray-700">
        <form id="falsereceiptInsertForm" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <!-- Project & Date -->
            <div class="flex flex-col md:flex-row gap-4 md:items-end">
                <div class="w-full md:w-2/4">
                    ...
                    <select id="project_id" name="project_id" class="project-select block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200">
                    </select>
                </div>
                ...
                <div class="w-full md:w-1/4">
                <label for="pay_method_id" class="block text-gray-700 dark:text-gray-200 font-medium mb-1">Account <span class="text-red-600">*</span></label>
...
$("#falsereceiptInsertForm").on('submit', function(e){
    e.preventDefault();
    let thisForm = $(this);

    $.ajax({
        type: "POST",
        url: "{{route('falsereceipt.store')}}",
