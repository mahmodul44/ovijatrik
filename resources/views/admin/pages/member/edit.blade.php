            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="name" type="text" name="name" :value="old('name',$member->name)"
                 ...
                 <div>
                        ...
                        <x-text-input id="member_id" type="text" name="member_id" :value="old('member_id',$member->member_id)"
                            class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="occupation" type="text" name="occupation" :value="old('occupation',$member->occupation)"
                            class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="phone_no" type="text" name="phone_no" :value="old('phone_no',$member->phone_no)"
                                class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                                required autocomplete="off" />
                        </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="email" type="email" name="email" :value="old('email',$member->email)"
                            class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                            required autocomplete="off" />
                    </div>
                 ...
                 <div>
                    <x-input-label for="monthly_donate" :value="__('Monthly Amount')"
                            class="text-gray-700 dark:text-gray-200 font-medium" />
                    <x-text-input id="monthly_donate" type="text" name="monthly_donate" :value="old('monthly_donate',$member->monthly_donate)"
                            class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                            required autocomplete="off" />
