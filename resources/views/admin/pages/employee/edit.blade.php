...
<div class="p-5 max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <nav
            ...
            <span>/</span>
            <span class="text-gray-700 dark:text-gray-200 font-semibold">Employee Update</span>
        </nav>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="name" type="text" name="name" :value="old('name',$employee->name)"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="designation" type="text" name="designation" :value="old('designation',$employee->designation)"
                                class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="department" type="text" name="department" :value="old('department',$employee->department)"
                                class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                                required autocomplete="off" />
                        </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="email" type="email" name="email" :value="old('email',$employee->email)"
                            class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                            required autocomplete="off" />
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="address" type="text" name="address" :value="old('address',$employee->address)"
                            class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                            required autocomplete="off" />
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="relative">
                        ...
                        <x-text-input id="join_date" type="date" name="join_date" :value="old('join_date',$employee->join_date)"
                            class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                            required autocomplete="off" />
                    </div>
                    ...
                    <div>
                       <x-input-label for="salary" :value="__('Salary')"
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="salary" type="text" name="salary" :value="old('salary',$employee->salary)"
                                class="block w-full rounded-xl border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"
                                required autocomplete="off" />
                        </div>
